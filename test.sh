...
assert 0 "int do_nothing(char *str) { return 0; }int main() {return do_nothing(\"hello\");}"
assert 65 "char first(char *str) { return str[0]; }int main() {return first(\"ABC\");}"
assert 66 "char second(char *str) { return str[1]; }int main() {return second(\"ABC\");}"
